...
4×4 Matrix{StaticArraysCore.SVector{2, Quantity{Float64, 𝐋^-1, Unitful.FreeUnits{(nm^-1,), 𝐋^-1, nothing}}}}:
 [0.0 nm^-1, 0.0 nm^-1]          …  [0.0 nm^-1, -0.00409836 nm^-1]
 [0.00409836 nm^-1, 0.0 nm^-1]      [0.00409836 nm^-1, -0.00409836 nm^-1]
 [-0.00819672 nm^-1, 0.0 nm^-1]     [-0.00819672 nm^-1, -0.00409836 nm^-1]
 [-0.00409836 nm^-1, 0.0 nm^-1]     [-0.00409836 nm^-1, -0.00409836 nm^-1]
```
"""
